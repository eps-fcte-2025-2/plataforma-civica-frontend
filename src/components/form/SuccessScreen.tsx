...
const SuccessScreen: React.FC<SuccessScreenProps> = ({ response, onNewReport }) => {
  return (
    <div className="max-w-2xl mx-auto p-6 bg-card-bg rounded-lg shadow-lg">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold text-foreground mb-2">Denúncia Enviada com Sucesso!</h2>
        <p className="text-muted mb-4">
          Sua denúncia foi registrada no sistema e receberá o número de protocolo:
        </p>
        <div className="bg-card-bg p-4 rounded-lg mb-6">
          <p className="text-lg font-mono text-foreground">{response?.id}</p>
