  ...
  return (
    <main className="min-h-screen grid place-items-center px-6 py-24">
      <div className="max-w-2xl text-center">
        ...
        <Link href="/dashboard" className="inline-flex items-center justify-center mt-6 px-4 py-2 rounded bg-blue-600 text-white hover:bg-blue-700 transition-colors">Ir para o Dashboard</Link>
      </div>
    </main>
  );
}
